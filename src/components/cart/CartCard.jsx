...
const CartCard = ({productId, quantity}) => {
  const [data, setData] = useState({productId, quantity})
  ...
  return (
    <div className='w-100 d-flex px-3 py-4 position-relative shadow rounded-3'>
      <div className="col-3">
        <img 
      ...
      <div className="col-9 h-auto d-flex flex-column pe-5">
        <h4 className='d-block fw-500 fs-7 text-start text-dark mb-3'>{data?.productId?.title}</h4>
        <div className="d-flex flex-column">
          <span className="price fw-500 text-secondary main-bg p-2 rounded-pill mx-auto">$500</span>
